...
function EditarReceitaPage() {
  ...
  const initial: Partial<ReceitaInput> | undefined = receita.data
    ? {
        categoriaId: receita.data.categoriaId,
        nome: receita.data.nome,
        descricao: receita.data.descricao,
        tempoPreparo: receita.data.tempoPreparo,
        porcoes: receita.data.porcoes,
        dificuldade: receita.data.dificuldade,
        imagem: receita.data.imagem ?? undefined,
        ingredientes: receita.data.ingredientes,
        passos: receita.data.passos,
      }
    : undefined;
